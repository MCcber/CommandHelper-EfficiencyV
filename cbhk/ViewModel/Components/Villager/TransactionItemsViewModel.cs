...
namespace CBHK.ViewModel.Components.Villager
{
    public partial class TransactionItemsViewModel:ObservableObject
    {
        ...
        {
            VillagerViewModel context = Window.GetWindow(sender as TransactionItemsView).DataContext as VillagerViewModel;
        ...
        {
            TransactionItemsView template_parent = button.FindParent<TransactionItemsView>();
        ...
        public void Edit(Button button)
        {
            ...
            context.CurrentItem = button.FindParent<TransactionItemsView>();
        }
