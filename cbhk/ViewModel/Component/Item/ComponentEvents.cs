...
namespace CBHK.ViewModel.Component.Item
{
    public class ComponentEvents
    {
        ...
        public void ValueChangedHandler(object sender, RoutedEventArgs e)
        {
            ...
            int currentIndex = 0;
            ItemPageViewModel context = parent.FindParent<ItemPageView>().DataContext as ItemPageViewModel;
        ...
        private void ClearStewEffectCommand(FrameworkElement obj)
        {
            ...
            {
                itemPageDataContext.VersionComponents.Remove(stackPanel.Children[i] as SuspiciousStewEffect);
        ...
        public async void CustomPotionEffects_LostFocus(object sender, RoutedEventArgs e)
        {
            ...
            await Application.Current.Dispatcher.InvokeAsync(async () =>
            {
                ...
                if (stackPanel.Children.Count > 0)
                {
                    int currentVersion = (accordion.FindParent<ItemPageView>().DataContext as ItemPageViewModel).CurrentMinVersion;
                    string effectString = "";
        ...
        public void AddItemCommand(FrameworkElement obj)
        {
            Accordion accordion = obj as Accordion;
            StackPanel itemPanel = (accordion.Content as ScrollViewer).Content as StackPanel;
            itemPanel.Children.Add(new InlineItem());
        }
