...
namespace cbhk.ViewModel.Generators
{
    public partial class VillagerViewModel:ObservableObject
    {
        ...
        /// 左侧交易项数据源
        /// </summary>
        public ObservableCollection<TransactionItemsView> transactionItems { get; set; } = [];
        /// <summary>
        /// 言论数据源
        /// </summary>
        ...
        #region 当前选中的物品
        [ObservableProperty]
        private TransactionItemsView _currentItem = null;
        ...
        {
            TransactionItemsView transaction = new()
            {
