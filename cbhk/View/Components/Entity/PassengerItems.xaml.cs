...
namespace cbhk.Generators.EntityGenerator.Components
{
    ...
    public partial class PassengerItems : UserControl
    {
        ...
        private void ReferenceIndex_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
            ...
            EntityViewModel entityContext = (Window.GetWindow(slider) as EntityView).DataContext as EntityViewModel;
            ...
            {
                EntityPagesViewModel pageContext = (entityContext.EntityPageList[index].Content as EntityPagesView).DataContext as EntityPagesViewModel;
