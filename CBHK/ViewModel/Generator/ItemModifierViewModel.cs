...
namespace CBHK.ViewModel.Generator
{
    ...
    {
        #region Property
        public override string ConfigDirectoryPath { get; set; } = AppDomain.CurrentDomain.BaseDirectory + @"Resource\Configs\ItemModifier\DataList\Rule\";
        ...
        #region Method
        public ItemModifierViewModel(IContainerProvider container, MainView mainView,CBHKDataContext Context,RegexService RegexService) : base(container, mainView,Context,RegexService)
        {
